...
Widget buildGenericPassCard(PkPass pass, BuildContext context) {
  final passTheme = GenericPassTheme.fromPass(pass);
  return Card(
    elevation: 4.0,
    ...
    child: ListTile(
      ...
      title: Text(
        pass.pass.generic!.primaryFields?.first.label ?? 'Pass',
        style: const TextStyle(fontWeight: FontWeight.bold),
      ),
      subtitle: Text(pass.pass.generic!.primaryFields?.first.value.toString() ?? ''),

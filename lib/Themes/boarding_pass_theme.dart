...
class BoardinPassTheme extends ThemeExtension<BoardinPassTheme> implements BasePassTheme {
  BoardinPassTheme({
  ...
  factory BoardinPassTheme.fromPass(PkPass pass) {
  ...
  @override
  ThemeExtension<BoardinPassTheme> copyWith() {
    return this;
  }

  @override
  ThemeExtension<BoardinPassTheme> lerp(covariant ThemeExtension<BoardinPassTheme>? other, double t) {
    return this;
  }
}

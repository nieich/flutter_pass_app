...
class CouponPassTheme extends ThemeExtension<CouponPassTheme> implements BasePassTheme {
  CouponPassTheme({
  ...
  factory CouponPassTheme.fromPass(PkPass pass) {
  ...
  @override
  ThemeExtension<CouponPassTheme> copyWith() {
    return this;
  }

  @override
  ThemeExtension<CouponPassTheme> lerp(covariant ThemeExtension<CouponPassTheme>? other, double t) {
    return this;
  }
}
